...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        user2 = User.objects.create_user(
            username="user2", password="password456", is_host=True
        )
        user3 = User.objects.create_user(
            username="guest1", password="password789", is_host=False
        )
        ...
        photo2 = Photo.objects.create(
            url="https://a0.muscache.com/im/pictures/miso/Hosting-40388474/original/fb5cce26-79f9-49bb-b85a-e198d45acf08.jpeg?im_w=720",
            alt_text="Photo 2",
        )
        photo3 = Photo.objects.create(
            url="https://a0.muscache.com/im/pictures/miso/Hosting-17234604/original/2a9bef54-6ce1-4417-b243-286fb994bd6f.jpeg?im_w=720",
            alt_text="Photo 3",
        )
        photo4 = Photo.objects.create(
            url="https://a0.muscache.com/im/pictures/662e5a71-e7ad-42e9-a81e-a6421502ecc3.jpg?im_w=720",
            alt_text="Photo 4",
        )
